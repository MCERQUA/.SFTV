// Video data with proper thumbnail paths

export const commercialShorts = [
  {
    id: 1,
...
export const commercialsLonger = [
  {
    id: 6,
...
export const musicVideoCommercials = [
  {
    id: 10,
...
export const funnyClips = [
  ...
  {
    id: 13,
    title: "Insulated Chicken Brothers",
  ...
  {
    id: 14,
    title: "Insulated Chicken Brothers 2",
