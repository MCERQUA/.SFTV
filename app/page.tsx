...
const commercialShorts = [
  {
    ...
    thumbnail: "/videos/commercial-shorts/Cortex-industries-Rex-oring-game-sm.mp4",
  ...
  },
  {
    ...
    category: "Commercial Short",
    thumbnail: "/videos/commercial-shorts/duckcleaning-commerical.mp4",
  ...
  },
  {
    ...
    category: "Commercial Short",
    thumbnail: "/videos/commercial-shorts/Graco Fusion AP.mp4",
  ...
  },
  {
    ...
    category: "Commercial Short",
    thumbnail: "/videos/commercial-shorts/koolfoam-fly-south.mp4",
  ...
  },
  {
    ...
    category: "Commercial Short",
    thumbnail: "/videos/commercial-shorts/noble-insulation-commerical-sm.mp4",
...
const commercialsLonger = [
  {
    ...
    thumbnail: "/videos/commercials-longer/EDI-Commerical.mp4",
  ...
  },
  {
    ...
    category: "Extended Commercial",
    thumbnail: "/videos/commercials-longer/ICA-Duct-Clean-Bodywash.mp4",
  ...
  },
  {
    ...
    category: "Extended Commercial",
    thumbnail: "/videos/commercials-longer/ICA-Getting-Ducts-Clean.mp4",
  ...
  },
  {
    ...
    category: "Extended Commercial",
    thumbnail: "/videos/commercials-longer/Only-Foam-SprayFoam-Party.mp4",
...
const musicVideoCommercials = [
  {
    ...
    thumbnail: "/videos/music-video-commercials/Mrs-SprayFoam-Call-Me-Maybe.mp4",
  ...
  },
  {
    ...
    artist: "Mrs. SprayFoam",
    thumbnail: "/videos/music-video-commercials/Mrs-Sprayfoam-Let-It-Foam.mp4",
...
const funnyClips = [
  {
    ...
    category: "Comedy",
    thumbnail: "/videos/funny-clips/Breaking-Batts.mp4",
  ...
  },
  {
    ...
    category: "Comedy",
    thumbnail: "/videos/funny-clips/Insulated-chicken-brothers-cartoon.mp4",
  ...
  },
  {
    ...
    category: "Comedy",
    thumbnail: "/videos/funny-clips/Insulated-Chicken-Brothers-Cartoon2.mp4",
